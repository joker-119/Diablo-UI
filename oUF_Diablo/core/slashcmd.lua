  ...
  local function SlashCmd(cmd)
    ...
    elseif (cmd:match"lockall") then
      ...
      print("|c00FF3300\/diablo unlockall|r, to unlock all frames")
      print("|c00FF3300\/diablo lockall|r, to lock all frames")
      print("|c00FF3300\/diablo resetkall|r, to reset all frames")
    end
  end
